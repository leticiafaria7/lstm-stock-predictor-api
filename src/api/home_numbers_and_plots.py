...
FEATURE_DESCRIPTIONS = {
    ...
    "high":"Maior preço do pregão.",
    "low":"Menor preço do pregão.",
    "open":"Preço de abertura.",
    "volume":"Volume negociado.",
    "close_dolar":"Cotação diária do dólar.",
    "close_ibovespa":"Fechamento do Ibovespa.",
    "close_sp_500":"Fechamento do S&P500.",
    "selic":"Taxa Selic.",
    "ipca":"Inflação IPCA.",
    "ma20":"Média móvel de 20 períodos.",
    "ma50":"Média móvel de 50 períodos.",
    "bb_upper":"Banda superior de Bollinger.",
    "bb_lower":"Banda inferior de Bollinger.",
    "rsi_wilder":"Relative Strength Index.",
    "macd":"Moving Average Convergence Divergence.",
    "macd_signal":"Linha de sinal do MACD.",
    "weekday_sin":"Codificação cíclica do dia da semana.",
    "weekday_cos":"Codificação cíclica do dia da semana.",
    "month_sin":"Codificação cíclica do mês.",
    "month_cos":"Codificação cíclica do mês."
}
